...
class AppPreferences {
  ...
  void setUserObject({required String userDataJSON}) => _setPreference(
      prefName: PREF_USER_DATA,
      prefValue: userDataJSON,
  ...
  Future<String> getUserObject() async {
    return await _getPreference(
        prefName:
            PREF_USER_DATA); // Check value for NULL. If NULL provide default value as FALSE.
  }
